...
const EditDevs = () => {
    ...
    useEffect(() => {
        axios.get('http://localhost:5050/developers/' + id,).then(res => {
            ...
            setDevinput({
                name : res.data.name , uName :  res.data.uName, cell : res.data.cell, photo : res.data.photo, email : res.data.email, skill : res.data.skill, gender : res.data.gender, yt : res.data.yt, git : res.data.git, tw : res.data.tw, lin : res.data.res, fb : res.data.fb 
            })
                                            ...
                                            <Col md={6}>
                                                ...
                                                <div className="my-1">
                                                    ...
                                                    <div className='mt-0'>
                                                        ...
                                                        <input checked={ gender === "Male" ? true : false } type="radio" id="Male" name='gender' value='Male' onChange={e => setDevinput( { ...devinput, gender : e.target.value } )} /> <label htmlFor="Male">Male</label> &nbsp;
                                                        <input checked={ gender === "Female" ? true : false } type="radio" id="Female" name='gender'  value='Female' onChange={e => setDevinput( { ...devinput, gender : e.target.value } )} /> <label htmlFor="Female">Female</label>
                                                    </div>
                                                </div>
                                            </Col>
                                            <Col md={6}>
